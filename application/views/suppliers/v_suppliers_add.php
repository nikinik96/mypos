                ...
                <div class="col-md-6">
                    <form action="" method="POST">
                        <div class="form-group <?= form_error('name') == TRUE ? 'has-error' : null ?>">
                            ...
                            <input type="text" name="name" id="name" class="form-control" autocomplete="off" autofocus placeholder="Nama Suppliers">
                            <?= form_error('name', '<div class="text-danger">', '</div>'); ?>
                        </div>
                        <div class="form-group <?= form_error('phone') == TRUE ? 'has-error' : null ?>">
                            <label for="phone">Tlp <i class="text-denger">*</i></label>
                            <input type="text" name="phone" id="phone" class="form-control" autocomplete="off" placeholder="Tlp Suppliers">
                            <?= form_error('phone', '<div class="text-danger">', '</div>'); ?>
                        </div>
                        <div class="form-group <?= form_error('address') == TRUE ? 'has-error' : null ?>">
                            <label for="address">Alamat <i class="text-denger">*</i></label>
