...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-body">
            <div class="card mb-3" style="max-width: 600px; border: 2px;">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src="<?= base_url('assets/dist/img/default.png') ?>" class="card-img" alt="...">
                    </div>
                    <div class="col-md-7 col-md-offset-1">
                        <div class="card-body">
                            <h5 class="card-title">
                                <h4 class="text-center">My Profile</h4>
                                <hr style="width: 35%; border: 1px solid black;">
                            </h5>
