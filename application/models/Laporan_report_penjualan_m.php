...
class Laporan_report_penjualan_m extends CI_Model
{
    public function get_result($id = NULL)
    {
        $this->db->select('*, sales_detail.qty as qty_sales, sales.date as date_sale, user.name as user_name, sales_detail.total as total_sales, sales.create as create_sales');
        $this->db->from('sales');
